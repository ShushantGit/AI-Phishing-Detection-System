...
# API_KEY      = "AIzaSyAr3quBDvPHJe4cBg0tzB4tLnnKojTB8qA"
...
#     # 4. API Layer (qualitative)
#     console.print(Panel(
#         """
# [bold cyan]Component 4: External Threat Intelligence APIs[/bold cyan]

#   Google Safe Browsing API
#     Strength  : Real-time blocklist, near-zero false positives.
#     Limitation: Only flags known threats; zero-day pages pass through.
#     Latency   : ~150-400 ms per lookup.

#   VirusTotal API
#     Strength  : Aggregates 70+ AV/URL scanning engines.
#     Limitation: Free tier rate-limited (4 req/min); new domains may have 0 hits.
#     Latency   : ~500-1500 ms (submit + fetch two-step).

#   Note: APIs evaluated qualitatively — live rate limits prevent
#   bulk offline dataset testing.
#         """,
#         title="[bold magenta]EXTERNAL APIs — Qualitative Evaluation[/bold magenta]", border_style="magenta"))
...
# VT_API_KEY = "cc85dcabff5234161be00b792248fba55f63980f9e352e60d1eacdacdafaa76e"
